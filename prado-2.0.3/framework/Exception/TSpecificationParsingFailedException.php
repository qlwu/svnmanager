<?php
/**
 * TSpecificationParsingFailedException class file.
 *
 ...
 *
 * TSpecificationParsingFailedException is raised when the framework
 * fails in parsing a component specification file.
 *
 * Namespace: Exception
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 ...
 * @package System.Exception
 */
class TSpecificationParsingFailedException extends TException
{
	/**
	 * Constructor.
