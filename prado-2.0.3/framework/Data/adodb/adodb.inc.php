	...
	*/
	...
	GLOBAL 
		...
		if (!isset($ADODB_CACHE_DIR)) {
			$ADODB_CACHE_DIR='cache'; //(isset($_ENV['TMP'])) ? $_ENV['TMP'] : '/tmp';
		} else {
...
*/
	...
	public $length='length';		/// string length operator
	...
	public $autoCommit=true; 	/// do not modify this yourself - actually public
	...
	* @param [secs2cache]		is a public parameter only used by jlim
	...
	* If $sql == false, then we purge all files in the cache.
	...
	/**
	* public function to generate filename for caching.
   ...
   /**
	...
	public $bind=false; 		/// used by Fields() to hold array - should be public?
   ...
   */
	...
	*/
	...
	/**
	 * Synonym for ADOLoadCode. public function. Do not use.
	 *
	 * @deprecated
	 */
	...
	/**
	 * Load the code for a specific database driver. public function. Do not use.
	 */
